...
def generate_layout(
    ...
    prompt = f"<|point_start|><|point_pad|><|point_end|> The reference code is as followed: {code_template}"
#doors, windows, boxes.Detect walls,
    ...
    if model.config.model_type == SpatialLMLlamaForCausalLM.config_class.model_type:
        ...
        conversation = [
            {"role": "system", "content": "You are a helpful assistant when you listen."},
